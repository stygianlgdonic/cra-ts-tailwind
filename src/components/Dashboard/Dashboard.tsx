...
const navigation = [
  { name: 'Dashboard', href: '/team1', current: true },
  { name: 'Team', href: '/team2', current: false },
  { name: 'Projects', href: '/team3', current: false },
  { name: 'Calendar', href: '/team4', current: false },
  { name: 'Reports', href: '/team5', current: false },
]
